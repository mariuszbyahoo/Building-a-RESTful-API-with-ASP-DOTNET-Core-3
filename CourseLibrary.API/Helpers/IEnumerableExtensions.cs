    ...
    public static class IEnumerableExtensions
    {
            ...
            string fields)
        {
            ...
            else
            {
                ...
                {
                    // trim each field, as might contain leading 
            ...
            {
                // for each sourceObject create an ExpandoObject
                // which will hold the selected properties & values
                ...
                foreach (var propertyInfo in propertyInfoList)
                {
                    ...
                    // add the field to the ExpandoObject, casted to IDictionary<K, V>
